...
const SubjectAccordion = ({
  ...
  return (
    <AccordionItem
      ...
      className="border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-1 bg-white/50 dark:bg-slate-800/50 hover:bg-white/80 dark:hover:bg-slate-800/80 transition-colors"
    >
      <AccordionTrigger className="hover:no-underline py-3">
        <div className="flex items-center gap-3 w-full">
          <div className="w-8 h-8 rounded-md bg-linear-to-br from-pink-400 to-purple-400 flex items-center justify-center shrink-0">
            <BookOpen className="w-4 h-4 text-white" />
          </div>
          <div className="flex-1 text-left">
            <div className="font-medium text-sm text-gray-800 dark:text-gray-100 capitalize">
              {subject.title}
            </div>
            {total > 0 && (
        ...
        <div className="space-y-4">
          {total > 0 && (
            <div className="grid grid-cols-3 gap-2 pt-2">
              <div className="flex items-center gap-2 p-2 rounded-md bg-green-50 dark:bg-green-900/20 border border-green-100 dark:border-green-800">
              ...
              <div className="flex items-center gap-2 p-2 rounded-md bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800">
              ...
              <div className="flex items-center gap-2 p-2 rounded-md bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-100 dark:border-yellow-800">
                <Circle className="w-4 h-4 text-yellow-600 dark:text-yellow-400" />
                <div>
